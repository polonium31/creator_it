                ...
                <form>
                  <div class="row mt-2" >
                    <div className="form-group col-md-6">
                      ...
                      <input type="text" className="form-control" style={{ fontSize: "24px" }} id="firstName" />
                    </div>
                    <div className="form-group col-md-6 ">
                      <label>Last Name</label>
                      <input type="text" className="form-control" style={{ fontSize: "24px" }} id="lastName" />
                    </div>
                  </div>
                  ...
                  <div class="row mt-2">
                    <div className="form-group col-md-6">
                      <label>Email</label>
                      <input type="email" className="form-control" style={{ fontSize: "24px" }} id="email" />
                    </div>
                    <div className="form-group col-md-6">
                      <label>Phone No.</label>
                      <input type="phone" className="form-control" style={{ fontSize: "24px" }} id="phoneNumber" />
                    </div>
                  </div>
                  <div class="row mt-2">
                    <div className="form-group col-md-6">
                      <label>Content Category</label>
                      <input type="text" className="form-control" style={{ fontSize: "24px" }} id="content" />
                    </div>
